/*
ORDER BY
Databese'de sıralama yapmamıza yardımcı komut.
...
--Tabloda petrol Turizm otobüslerinin çıkış saatini büyükten küçüğe doğru sıralayın
...
-- Tabloya göre çıkış saati 12'den sonra olan otobüs firmalarını yolcu sayısına göre sırala
...
--Tabloda sınav notu 80'den büyük olan ilk 3 notu listele
...
--Kaç kişi atlamasını istiyorsak OFFSET sayı kullanılır.

--Tabloda öğrenci sırası en sondaki öğrencilerden ilk ikisinden sonraki 5 datayı listele
